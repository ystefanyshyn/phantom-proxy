...
//    });
    ...
    var createServer = function (options, callbackFn, cb) {
...
//            callbackFn.call(self, self.proxy);
            ...
            var spawnNewProcess = function (cb) {
            ...
            var ensureServerRunning = function (cb) {
...
//use to see if  phantom server already runnings
    ...
    module.exports = {
        ...
        create:function (options, callbackFn, cb) {
            var self = this;
